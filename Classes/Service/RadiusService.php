...
class RadiusService
{
    ...
    protected float $earthRadius = 6378.1;
     ...
     */
    public function getDistance(array $coordinates1, array $coordinates2): float
    {
        // formula taken from here: http://snipplr.com/view.php?codeview&id=2531
        $pi80 = M_PI / 180;
